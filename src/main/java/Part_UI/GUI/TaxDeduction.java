...
// panel กลาง: หัวข้อ
    ...
    JPanel centerPanelTop = new 
    JPanel(new FlowLayout(FlowLayout.CENTER, 0, 15));
    centerPanelTop.setOpaque(false);
    centerPanelTop.add(titleLabel);

    // panel ขวา: กล่องว่างหลอกไว้ถ่วง layout ให้บาลานซ์กับปุ่มย้อนกลับ
    JPanel rightPanel = new JPanel();
    rightPanel.setOpaque(false);
    rightPanel.setPreferredSize(leftPanel.getPreferredSize()); // ให้ขนาดเท่ากับฝั่งซ้าย
...
// เพิ่มเข้า JFrame
    add(topPanel, BorderLayout.NORTH);
        ...
        // ===== รวมสามกล่องกลาง =====
        JPanel centerPanel = new JPanel(new FlowLayout(FlowLayout.CENTER, 25, 20)); // เพิ่มระยะห่าง Y
